...
Analyst 是 [hermes-multi-agent-setup](./concepts/hermes-multi-agent-setup.md) 中的**知識綜合者**，負責把 Scout 蒐集的原始 signal 轉為結構化 wiki 筆記。
...
## 排程
通常每日一次，搭配 [wakeAgent-gate](./concepts/wakeagent-gate.md)，只有在 inbox 非空時才喚醒。
...
- [wakeAgent-gate](./concepts/wakeagent-gate.md)
